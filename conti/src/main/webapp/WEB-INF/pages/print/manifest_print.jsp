	       ...
	       <!--===============heading ==============      -->	
	        	...
	        	<table id="basic-table">
	               ...
	               <thead>	    
	                    ...
	                    <c:forEach var="manifest" items="${listManifest}" varStatus="loop">	                    
	                        <tr>
                              	<td><c:out value="${loop.count}" />
                              	<td>${manifest.manifest_prefix}</td> 
                                <td>${manifest.branchModel1.branch_name}</td>                   
                                <td>${manifest.branchModel1.branch_name}</td> 
                                <td>${manifest.vehicleMaster.vehicle_regno}</td>  
                                <td>${manifest.employeeDriver.emp_name}</td>
                                <td>${manifest.manifest_status}</td> 
                                <td>${manifest.manifestDetailModel.size()}</td> 
                            </tr>                           
	                      </c:forEach> 
