package com.conti.manifest.view;
...
/**
 * @Project_Name conti
 * @Package_Name com.conti.manifest.view
 * @File_name ViewManifestController.java
 * @author Sakthi
...
public class ViewManifestController {
	...
	final Logger logger = LoggerFactory.getLogger(ViewManifestController.class);
